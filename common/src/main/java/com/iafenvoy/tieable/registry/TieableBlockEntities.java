...
public final class TieableBlockEntities {
    ...
    public static final RegistrySupplier<BlockEntityType<TiedBlockEntity>> TIED = register("tied", () -> BlockEntityType.Builder.create(TiedBlockEntity::new, TieableBlocks.TIED.get(), TieableBlocks.TIED_PILLAR.get()).build(null));
